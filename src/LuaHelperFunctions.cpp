...
/*
TODO ESTO SE DEBE PASAR A SOL3.0, es facil pero estoy idiota
*/
...
void luah::lua_gettostack(lua_State *L, std::string &variableName) {
  int level = 0;
  std::string var = "";
...
std::vector<std::string> luah::getTableKeys(lua_State *L,
